...
Author: Olena Merkotan

## 📌 Project Overview

An analytical project evaluating hospital operational efficiency, patient turnover, and emergency room utilization across all 50 U.S. states and the District of Columbia. The project uses aggregated administrative enrollment and real encounter records obtained from the Centers for Medicare & Medicaid Services (CMS).
...
* **Source:** CMS Program Statistics, Office of Enterprise Data and Analytics.
...
## 📊 Dashboard View
![Dashboard Preview](image_3e72f1.png)
...
- **Scope:** The data is based on inpatient hospital encounter records submitted by Medicare Advantage Organizations to CMS.
- **Categorization:** An algorithm was applied to categorize inpatient hospital encounter records by hospital type consistent with fee-for-service categorization.
